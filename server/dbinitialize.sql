...
INSERT OR IGNORE INTO startup (startup_id,name,yt_link,email,content)
VALUES (4444444444444,"ShareCare","https://www.youtube.com/embed/1LBu2aslGyA","johnmiurda@newimmune.com","Founded by a group of exhausted medical staff, we seek to reforge the health industry and erase it's inefficiencies. Our first product enables practitioners and patients to connect without 
...
INSERT OR IGNORE INTO startup (startup_id,name,yt_link,email,content)
VALUES (5555555555555,"Solomon Expeditions Inc.","https://www.youtube.com/embed/p-HxhJLUYhk","solomonjames@solomon.com","Since establishing in 2010, we've succesfully managed 14 early stage gold exploration projects. We have a team of top geologists and have a solid system of evaluating future projects. 
